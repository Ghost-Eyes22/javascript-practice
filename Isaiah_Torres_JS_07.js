...
function plusFive(string) {
  // your code here...
  let result= "plusFive " + string;
  return result;
}
...
function isCool(string) {
  let result = "isCool " + string 
  return result;
}
//console.log(isCool("Music"))
//console.log(isCool("Java Script"))
...
function averageOfTwo(num1, num2) {
  let result= "averageOfTwo " + string
